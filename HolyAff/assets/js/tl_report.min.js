var stack_msg = [],
    ...
    processError = function (e, r, t, n, i) {
        try {
            ...
            if (e && e.message)
                s.err = { msg: e.message, file: e.filename || e.fileName, ln: e.lineno || e.lineNumber, col: e.colno || e.columnNumber, stacktrace: e.stack ? e.stack : !1, cause: r ? JSON.stringify(r) : !1, errorObj: i ? i : !1 };
            else if (((s.err = { msg: e, ln: t, col: n, url: r }), r)) s.err.file = r;
            ...
            var o = (/[^/]+\.js/i.exec(s.err.file || "") || [])[0] || "inlineScriptOrDynamicEvalCode",
                a = { msg: [s.err.msg, " Occurred in ", o, ":", s.err.ln || "?", ":", s.err.col || "?"].join(""), url: window.location.href, referer: document.referrer, page_id: pI };
            if (s.err.ref) a.ref = "reference: " + s.err.ref;
            sendError(a);
        } catch (e) {
            var c = e.name + " - " + e.message;
            if (e.name && !1 === stack_msg.toString().indexOf(c)) stack_msg.push(c), sendError({ msg: e.message, url: window.location.href, referer: document.referrer, page_id: pI, catched: !0 });
        }
    };
function wrap(e) {
    if (!e._wrapped)
        e._wrapped = function () {
            try {
                ...
                var r = {};
                if (e && e.message) (r.err = { msg: e.message, stacktrace: e.stack ? e.stack : !1 }), sendError({ msg: r.err.msg + " Stacktrace: " + r.err.stacktrace });
            }
        };
    return e._wrapped;
}
if (
    ((window.onerror = function (e, r, t, n, i) {
